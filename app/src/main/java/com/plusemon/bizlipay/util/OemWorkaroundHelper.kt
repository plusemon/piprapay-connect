package com.plusemon.bizlipay.util
        ...
        return when (brand) {
            OemBrand.XIAOMI -> OemGuidance(
                ...
                autostartSteps = listOf(
                    ...
                    "Find 'BizliPay Connect' and toggle the Autostart switch to ON.",
                    "Tap on BizliPay Connect and enable 'Allow background start'."
                ),
                ...
                lockRecentsSteps = listOf(
                    ...
                    "Long-press or pull down on BizliPay Connect window.",
            ...
            OemBrand.OPPO -> OemGuidance(
                ...
                autostartSteps = listOf(
                    ...
                    "Under Startup Manager / Auto-launch, enable 'BizliPay Connect'.",
                    "Enable 'Allow background activity'."
                ),
                batterySaverSteps = listOf(
                    "Tap 'Disable Battery Saver' below.",
                    "Set BizliPay Connect Battery usage to 'Allow Background Activity' & 'Don't Optimize'."
                ),
                lockRecentsSteps = listOf(
                    "Open Recent Apps tray.",
                    "Tap the 2-dots / 3-dots icon at top right of BizliPay Connect.",
            ...
            OemBrand.VIVO -> OemGuidance(
                ...
                lockRecentsSteps = listOf(
                    ...
                    "Slide down on the BizliPay Connect card.",
                    "Tap the Lock icon."
                )
            )
            OemBrand.SAMSUNG -> OemGuidance(
                ...
                autostartSteps = listOf(
                    ...
                    "Add BizliPay Connect to 'Never sleeping apps'."
                ),
                batterySaverSteps = listOf(
                    "Tap 'Disable Battery Saver' below.",
                ...
                lockRecentsSteps = listOf(
                    ...
                    "Tap the BizliPay Connect app icon above its preview.",
                ...
                lockRecentsSteps = listOf(
                    "Open Recent Apps screen.",
                    "Lock BizliPay Connect if supported by your launcher."
                )
            )
        }
    }
